                    ...
                    <div className="navigation d-flex">
                        ...
                        <ul className="navbar-nav nav-right ml-auto">
                            <li className="nav-item dropdown">
                                ...
                                <div
                                    className="dropdown-menu extended animated fadeIn"
                                    aria-labelledby="navbarDropdown"
                                >
                                    <ul>
                                        <li className="dropdown-header bg-gradient p-4 text-white text-left">
                                            Messages
                                            <label className="label label-info label-round">
                                                6
                                            </label>
                                            <a
                                                href="#"
                                ...
                                >
                                    ...
                                    <div className="p-4">
                                        <Link
                                            ...
                                            to="/profile"
                                        >
                                            <i className="fa fa-user pr-2 text-success"></i>{" "}
                                            Profile
                                        </Link>
                                        <Link
                                            className="dropdown-item d-flex nav-link"
                                            to="/setting"
                                        >
                                            <i className="ti ti-settings pr-2 text-info"></i>{" "}
                                            Settings
                                        </Link>
                                        <a
                                            href={void 0}
                                            ...
                                            className="dropdown-item d-flex nav-link"
                                        >
                                            <i className="ti ti-key pr-2 text-danger"></i>{" "}
                                            Locked
                                        </a>
                                    </div>
                                </div>
